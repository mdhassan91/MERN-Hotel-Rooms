...
var mongoURL="mongodb+srv://mdhassan91:HASSAN91@cluster0.lefdx.mongodb.net/mern-rooms";
...
db = [
  ...
  },
  {
    ...
    currentbookings: [],
    description:
      "Couples are welcome Guests can check in using any local or outstation roomId proof (PAN card not accepted). Only Indian Nationals allowed As a complimentary benefit, your stay is now insured by Acko. This hotel is serviced under the trade name of Sri Navya Grand as per quality standards of OYO",
  },
  {
    roomId: 5,
    ...
    currentbookings: [],
    description:
      "Night Curfew in Telangana | Check-in allowed between 05:00 AM to 09:00 PM Couples are welcome Guests can check in using any local or outstation roomId proof (PAN card not accepted). As a complimentary benefit, your stay is now insured by Acko.This hotel is serviced under the trade name of The City Park as per quality standards of OYO",
  },
];
